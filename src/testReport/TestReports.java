...
/**
 * ExtentReports  is a HTML reporting library for Selenium WebDriver 
...
public class TestReports {
	 ...
	 */
	private final static TestReports instance = new TestReports();
	 ...
	 */
	public static TestReports get(Class<?> clazz) {
	 ...
	 * @return an ExtentReports object
	 */
	public static TestReports get(String className) {
